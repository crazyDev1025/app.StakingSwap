...
const ot = [
  ...
  Gn = {
    56: {
      AXI: "0x0409633A72D846fc5BBe2f98D88564D35987904D",
    ...
    97: {
      AXI: "0xB19586D1C0322Fc48bB784f5aF4A862c21dd03f3",
...
const da = P(ee)(({ theme: { palette: t } }) => ({
  ...
  "&.MuiButton-contained": {
    background: "linear-gradient(80.54deg, #00c2ff 0%, #6e00ff 100%)",
    "&:hover": {
      background:
        "linear-gradient(0deg, rgba(255, 255, 255, 0.25), rgba(255, 255, 255, 0.25)), linear-gradient(80.54deg, #00c2ff 0%, #6e00ff 100%)",
    },
    "&.Mui-disabled": {
      background:
        ...
        Xe,
        {
          ...
          sx: {
            ...
            "::before": {
              ...
              width: "2px",
              height: "100%",
              background: "linear-gradient(to right, #00c2ff 0%, #6e00ff 100%)",
  ...
  const { connected: n } = I(),
    ...
    b = i.exports.useMemo(() => {
      const f = [
        ...
        { label: "Total Staked", value: `${T(l)} XKAYA` },
      ];
      return (
        n &&
          f.push({
      ...
      if (u) {
        try {
          ...
          console.log("Harvest:", g),
            r(`Successfully harvested ${T(c)} AXI`, { variant: "success" }),
            y();
        } catch (d) {
  ...
  const [s, a] = i.exports.useState(!1),
    ...
    v = i.exports.useCallback(async () => {
      ...
      console.log("Unstake:", E),
        c(`Successfully unstaked ${T(p)} XKAYA`, { variant: "success" }),
        u(),
        g();
    }, [b, p, c, u, g]),
    B = i.exports.useCallback(async () => {
  ...
  za = {
    AXI_V2: {
      ...
      Unstake: e.createElement(
        e.Fragment,
        null,
        "Unstaking is subject to a 7-day hold. Once the hold has been completed, you may withdraw your XKAYA back to your wallet.",
        e.createElement("br", null),
        e.createElement("br", null),
    ...
    AXI_V1: {
      ...
      Unstake: e.createElement(
        e.Fragment,
        null,
        "The unstaking hold period has been removed for this pool. You may immediately withdraw your XKAYA to your wallet below after unstaking first.",
        e.createElement("br", null),
        e.createElement("br", null),
        "Note: Unstaking will automatically harvest your rewards."
      ),
...
function _a({ pool: t, token: n, logo: s, disabledActions: a }) {
  ...
  const [r, o] = i.exports.useState(!1),
    ...
    De = i.exports.useCallback(async () => {
      ...
      console.log("Stake:", J),
        p(`Successfully staked ${T(h)} XKAYA`, { variant: "success" }),
        g(),
        se();
    }, [z, A, v, p, g, se]),
    Oe = i.exports.useCallback(async () => {
      ...
      console.log("Apply:", H),
        p(`Successfully applied withdrawal of ${T(A)} XKAYA`, {
          variant: "success",
        }),
        g(),
        se();
  ...
  return e.createElement(
    ...
    e.createElement(
      ...
      e.createElement(
        ...
        e.createElement(Mt, null, "Stake $XKAYA"),
        e.createElement(Qa, { pool: "AXI_V2" })
      ),
      e.createElement(
        x,
        { variant: "subtitle2", mb: 3, lineHeight: "24px" },
        "Stake the new XKAYA V2 token to earn XKAYA. ",
        e.createElement("br", null),
    ...
    e.createElement(
      ...
      e.createElement(
        x,
        { variant: "subtitle2", mb: 3, lineHeight: "24px" },
        "This pool is no longer active. You must unstake and migrate your tokens to the new XKAYA V2 token. Migrate your tokens",
        " ",
        e.createElement(
          Ye,
  ...
  return e.createElement(
    ...
    e.createElement(
      ...
      e.createElement(
        ts,
        null,
        e.createElement("span", { className: "gradientText" }, "XKAYA"),
        " Swap"
      )
    ),
    e.createElement(
    ...
    e.createElement(
      ...
      e.createElement(
        ...
        e.createElement(
          m,
          { mb: 4 },
          e.createElement(Ht, { label: `XKAYA Balance`, value: T(u), suffix: "XKAYA"})
        ),
        e.createElement(
          m,
          { my: 4 },
...
const as = [
  {
    ...
    description: e.createElement(
      e.Fragment,
      null,
      "Swap ERC-20 XKAYA V1 tokens for XKAYA V2 tokens ",
      e.createElement("br", null),
      " at a 100:1 rate."
    ),
    moreLink:
      "https://phoenixglobal.medium.com/AXI-token-redenomination-1b321687daa",
  },
  {
    token: "ETH",
    tokenName: "ETH",
    ...
    description: e.createElement(
      e.Fragment,
      null,
      "Swap ETH tokens for XKAYA V2 tokens ",
      e.createElement("br", null),
      " at a 100:1 rate."
    ),
    moreLink:
      "https://phoenixglobal.medium.com/AXI-token-redenomination-1b321687daa#be16",
  },
];
function ss() {
  return e.createElement(
